...
from fixture_and_parametrize_22Modul_PyTest_API.settings import valid_password, valid_email, invalid_email, invalid_age, \
    invalid_name
import os

pf = PetFriends()

'''Автоматизация с параметризацией для позитывных тестов'''
...
'''Автоматизация с параметризацией для негативных тестов'''
